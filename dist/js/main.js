...
var style0 = __webpack_require__(3);
style.use();
style0.use();
function hide(el) {
  if (el) {
...
// module
exports.push([module.i, "div.small{position:relative;width:100%;height:450px;margin-bottom:10px;display:inline-block}div.ab_button{position:absolute}iframe{width:100%;height:inherit}div.full{position:fixed;top:0;left:0;background:#fff;width:100%;height:100%}iframe{border-width:0}", ""]);
...
// module
exports.push([module.i, "body{margin:0}.hide{display:none!important}", ""]);
